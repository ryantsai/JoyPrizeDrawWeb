...
window.landingMessages.ko = {
  metaTitle: "Joy Prize Draw | 당첨 발표를 무대처럼 보여주는 랜딩 페이지",
  metaDescription: "교실, 파티, 스트리밍, 현장 이벤트를 위한 세련된 추첨 앱.",
  nav: { modes: "모드", flow: "진행 방식", organizers: "운영 기능", faq: "FAQ" },
  languageLabel: "언어",
  heroEyebrow: "교실, 파티, 스트리밍, 라이브 이벤트를 위한 추첨 앱",
  heroTitle:
  ...
  heroNote:
    "이 버전은 앱에 포함된 아트를 활용합니다. 이후 전환율을 더 높이려면 실제 앱 스크린샷이나 디바이스 목업을 2~3장 추가하는 것이 좋습니다.",
  visualChipTop: "8가지 추첨 스타일",
  visualChipBottom: "팩 저장, 기록, 다국어 UI 지원",
  stats: [
    { value: "8", label: "가지 당첨 연출" },
    { value: "재사용", label: "아이템 팩과 참가자 목록" },
    { value: "10", label: "개 로케일 기본 지원" },
  ],
  modesEyebrow: "추첨 모드",
  modesTitle: "현장 분위기를 살리면서 8가지 방식으로 당첨자를 정하세요.",
  modesIntro:
  ...
  modes: [
    ...
    { name: "랜덤", body: "연출보다 속도가 중요할 때 바로 결과를 보여주는 모드입니다.", symbol: "★" },
  ],
  workflowEyebrow: "빠른 준비",
  workflowTitle: "목록 준비부터 공개까지, 짧은 세 단계면 충분합니다.",
  workflowIntro:
  ...
  organizersTitle: "애니메이션만 멋진 것이 아니라 진행자의 실무도 가볍게 합니다.",
  organizersIntro:
    "재사용 가능한 팩, 참가자 모드, 당첨 제한, 대량 입력, 내보내기, 기록 관리까지 갖춰 운영 도구로도 충분합니다.",
  features: [
    { title: "재사용 가능한 아이템 팩", body: "자주 쓰는 경품 구성을 저장해 두었다가 다음 이벤트에서 바로 불러올 수 있습니다." },
    { title: "참가자 모드", body: "경품 풀과 참가자 풀을 분리해 관리할 수 있어 구조화된 추첨에 잘 맞습니다." },
    { title: "당첨 기록", body: "누가 무엇을 받았는지 시간 순서대로 남겨 공유와 검토가 쉬워집니다." },
    { title: "대량 등록과 번호 생성", body: "목록 붙여넣기와 자동 번호 생성으로 대규모 이벤트 준비 시간을 줄입니다." },
    { title: "이모지, 색상, 이미지 단서", body: "항목을 시각적으로 구분하기 쉬워져 진행 중 확인이 빨라집니다." },
    { title: "내보내기와 제어 옵션", body: "CSV/TXT 내보내기, 당첨 제한, 당첨 항목 제거를 지원해 중복 결과를 막을 수 있습니다." },
  ],
  audiencesEyebrow: "어디에 잘 맞나",
  audiencesTitle: "공정함도 필요하고 분위기도 살려야 하는 라이브 순간에 잘 맞습니다.",
  audiencesIntro:
    "가볍게 즐길 수 있으면서도 진행 신뢰감은 놓치지 않는 균형을 목표로 했습니다.",
  audiences: [
    { title: "교실과 동아리", body: "학생 지목, 복습 게임, 보상 추첨, 팀 활동을 빠르게 운영할 수 있습니다." },
    { title: "스트리밍과 무대 이벤트", body: "화면에 잘 보이는 연출을 제공하면서도 당첨자 관리 흐름을 유지할 수 있습니다." },
  ...
  ctaBody:
    "강한 히어로, 모드 소개, 운영 기능 증명, 언어 전환, 정적 배포 구조까지 이미 갖춰져 있어 나중에 확장하기 쉽습니다.",
  ctaPrimary: "히어로로 돌아가기",
  ctaSecondary: "모드 다시 보기",
  ctaNote:
    "플랫폼 링크와 최신 스크린샷이 준비되면 디자인을 다시 만들지 않고도 자연스럽게 확장할 수 있습니다.",
