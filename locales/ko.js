...
window.landingMessages.ko = {
  ...
  features: [
    ...
    { title: "내장 스타터 팩", body: "타로 카드, 포커 카드, 매직 8볼 답변, 이야기 시작 아이디어, 점심 메뉴, 사진 챌린지 등 15가지 내장 팩을 바로 불러올 수 있습니다. 설정 없이 시작하세요." },
    { title: "귀여운 햄스터 가이드", body: "사랑스러운 햄스터가 매번 추첨에 함께하며 발표 순간을 더 따뜻하고 즐겁게 만들어 줍니다(일부 모드에서 이용 가능)." },
