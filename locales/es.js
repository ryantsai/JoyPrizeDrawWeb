...
window.landingMessages.es = {
  metaTitle: "Joy Prize Draw | Una landing para sorteos con presencia escenica",
  metaDescription:
    "Una app de sorteos cuidada para aulas, fiestas, streams y eventos en vivo.",
  nav: { modes: "Modos", flow: "Flujo", organizers: "Organizacion", faq: "FAQ" },
  languageLabel: "Idioma",
  heroEyebrow: "App de sorteos para aulas, fiestas, streams y eventos en vivo",
  heroTitle:
  ...
  heroNote:
    "Esta version usa imagenes incluidas en la app. Mas adelante, para mejorar conversion, conviene sumar 2 o 3 capturas reales de la interfaz o mockups de dispositivo.",
  visualChipTop: "8 estilos de sorteo",
  ...
  modesTitle: "Ocho formas de elegir un ganador sin perder el ritmo del momento.",
  modesIntro:
    "Elige la energia adecuada para una clase, un giveaway en directo, una fiesta o una seleccion rapida.",
  modes: [
  ...
  organizersTitle: "No solo luce bien: tambien le quita trabajo a quien lleva el sorteo.",
  organizersIntro:
  ...
  features: [
    ...
    { title: "Pistas visuales", body: "Emojis, colores e imagenes ayudan a leer mejor listas con muchos elementos." },
    { title: "Exportacion y control", body: "CSV/TXT, limites de victorias y eliminacion de ganadores para evitar repeticiones." },
  ],
  audiencesEyebrow: "Donde encaja mejor",
  audiencesTitle: "Ideal cuando necesitas equilibrio entre justicia, ritmo y diversion.",
  audiencesIntro:
    "Lo bastante alegre para una fiesta y lo bastante fiable para un sorteo organizado.",
  audiences: [
    { title: "Aulas y talleres", body: "Sirve para dinamicas de clase, juegos de repaso, premios y actividades de grupo." },
    { title: "Streams y eventos en vivo", body: "La revelacion se ve bien en pantalla y el control de ganadores sigue claro." },
  ...
  ctaBody:
    "Hero fuerte, muestra de modos, argumentos para organizadores, selector de idioma y archivos estaticos listos para desplegar: ya tienes una base muy solida.",
  ctaPrimary: "Volver al hero",
  ctaSecondary: "Revisar modos",
  ctaNote:
    "Cuando tengas enlaces de plataforma y nuevas capturas, la pagina se podra ampliar sin rehacer el diseno.",
  footerTagline:
